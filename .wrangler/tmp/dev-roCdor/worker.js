...
// .wrangler/tmp/bundle-qhG1pE/checked-fetch.js
...
function sanitizeString(value) {
  if (!value) return "";
  try {
    const sanitized = value.replace(/[^\w\s\-.,()[\]'"&]/g, "").replace(/'/g, "''").trim().slice(0, 500);
    if (value !== sanitized) {
    ...
    try {
      ...
      if (url.pathname.endsWith("/sse")) {
        if (method === "GET") {
          ...
          const writeSSE = /* @__PURE__ */ __name((data, event) => {
            let message = "";
...
// .wrangler/tmp/bundle-qhG1pE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-qhG1pE/middleware-loader.entry.ts
